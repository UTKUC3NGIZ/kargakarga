...
export default function Home() {
  return (
    <main class="bg-gray-50  antialiased">
        ...
        <div class="flex flex-wrap justify-between items-center">
          <div class="flex justify-start items-center">
            <button
              ...
              type="button"
              class="inline-flex items-center p-2 mr-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 "
            >
            ...
            >
              ...
              <div class="grid grid-cols-3 gap-4 p-4">
                ...
                >
                  ...
                  <div class="text-sm text-gray-900 ">Products</div>
                </a>
                <a
                  href="#"
                  class="block p-4 text-center rounded-lg hover:bg-gray-100  group"
                >
                  ...
                  <div class="text-sm text-gray-900 ">Pricing</div>
                </a>
                <a
                  href="#"
                  class="block p-4 text-center rounded-lg hover:bg-gray-100  group"
                >
                  ...
                  <div class="text-sm text-gray-900 ">Billing</div>
                </a>
                <a
                  href="#"
                  class="block p-4 text-center rounded-lg hover:bg-gray-100  group"
      ...
      <aside
        id="sidebar-double"
        class="flex z-40 fixed top-[3.5rem] left-0 h-full transition-transform -translate-x-full lg:translate-x-0"
        aria-label="Sidebar"
      >
        <div class="overflow-y-auto z-30 py-5 px-3 w-16 h-full bg-[#363F72] border-r border-gray-200 flex justify-between flex-col">
          <ul class="space-y-2">
            <li>
              <a
                href="#"
                class="flex items-center p-2 text-gray-400 rounded-lg transition duration-75  hover:text-gray-900  hover:bg-gray-100 "
              >
                <svg
                  aria-hidden="true"
                  class="w-6 h-6"
          ...
          <div>
            <div class="relative inline-flex items-center justify-center w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600 mb-12">
        ...
        <div
          ...
          class="overflow-y-auto py-5 px-3 w-64 h-full bg-white border-r border-gray-200  transition-transform left-0 top-0 transform-none"
        >
          <ul class="space-y-2">
            <li>
              <span className="flex items-center p-2 text-base font-medium text-[#101828] rounded-lg group">
                Projeler
              </span>
            </li>
            <li>
              ...
              >
                <span class="flex-1 text-left whitespace-nowrap">Proje 1</span>
                <svg
                  aria-hidden="true"
                  class="w-6 h-6"
                  fill="currentColor"
          ...
          <div class="flex absolute -left-4 bottom-16 z-20 justify-end w-full bg-white ">
            <div class="flex items-center gap-4">
              <div class="font-medium ">
                <div className="font-semibold text-sm text-[##101828]">
                  Utku Cengiz
                </div>
                <div class="text-sm font-normal text-[#475467]">
        ...
        <button
          ...
          type="button"
          class="inline-flex absolute bottom-16 left-20 p-2 text-gray-500 rounded-full cursor-pointer  hover:text-gray-900 hover:bg-gray-200 bg-white hidden"
        >
          <svg
            class="w-6 h-6"
            fill="currentColor"
